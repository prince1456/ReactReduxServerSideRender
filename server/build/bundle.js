...
//tell outside world of our public dirctorny
/** Change nodejs to es2015  */
...
/**
 * use serialize to protect the html file would not derictly run js string in our client side web page.
 */
...
exports.default = (0, _reactRedux.connect)(mSTP)(Header);
...
exports.default = {
    loadData: loadData,
    component: (0, _reactRedux.connect)(mSTP, { fetchUsers: _actions.fetchUsers })(UsersListPage)
};
...
exports.default = {
    ...
    component: (0, _reactRedux.connect)(mSTP, { fetchAdmins: _actions.fetchAdmins })((0, _requireAuth2.default)(AdminsListPage))
};
...
exports.default = function (ChildComponent) {
    ...
    return (0, _reactRedux.connect)(mSTP)(RequireAuth);
};
...
exports.default = function (req) {
    var url = 'http://react-ssr-api.herokuapp.com';
